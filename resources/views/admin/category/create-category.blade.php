        ...
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="box box-primary">
                  ...
                  <!-- form start -->
                  <form action="{{ url('admin-adminv2/category-get-info') }}" method="post">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label>Category Name <span style="color:red;">*</label>
                            <input type="text" class="form-control" value="{{ old('categoryname') }}" name="name" placeholder="Enter Category Name">
