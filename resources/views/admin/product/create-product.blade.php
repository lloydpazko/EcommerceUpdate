        ...
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="box box-primary">
                  ...
                  <!-- form start -->
                  <form action="{{ url('admin-adminv2/product/post_product') }}" method="post">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label>Title <span style="color:red;">*</label>
                            <input type="text" class="form-control" value="{{ old('title') }}" name="title" placeholder="Product title here" required>
