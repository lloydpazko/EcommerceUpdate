...
<html>
  ...
  <body class="skin-blue">
    ...
    <!-- daterangepicker -->
    <script src="{{ url('assets/plugins/daterangepicker/daterangepicker.js') }}" type="text/javascript"></script>
    <!-- datepicker -->
    ...
    <!-- AdminLTE dashboard demo (This is only for demo pzurposes) -->
    {{-- <script src="{{ url('public/assets/dist/js/pages/dashboard2.js') }}" type="text/javascript"></script> --}}
