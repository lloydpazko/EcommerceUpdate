        ...
        <div class="row">
            ...
            <div class="col-md-11">
                ...
                <div class="box box-primary">
                  ...
                  <!-- form start -->
                  <form action="{{ url('admin-adminv2/colors/post_color') }}" method="post">
                    {{ csrf_field() }}
                    <div class="box-body">
                        <div class="form-group">
                            <label>Color name <span style="color:red;">*</label>
                            <input type="text" class="form-control" value="{{ old('name') }}" name="name" placeholder="Enter Type of Color">
                            {{-- <div style="color:red;">{{ $errors->first('storename') }}</div> --}}
                          </div>

                          <div class="form-group">
                            <label>Color Code <span style="color:red;">*</label>
                            <input type="color" class="form-control" value="{{ old('code') }}" name="code" placeholder="Enter Color Code">
                            {{-- <div style="color:red;">{{ $errors->first('storename') }}</div> --}}
                          </div>
                    ...
                    <div class="box-footer">
                      <button type="submit" class="btn btn-primary">Create Variant Colors</button>
                    </div>
                  </form>
                </div><!-- /.box -->
        </div><!-- /.row -->
