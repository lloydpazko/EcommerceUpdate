            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages">
                ...
                <div class="direct-chat-msg">
                  ...
                  <img class="direct-chat-img" src="{{ asset('assets/dist/img/user1-128x128.jpg') }}" alt="message user image" /><!-- /.direct-chat-img -->
                ...
                <div class="direct-chat-msg right">
                  ...
                  <img class="direct-chat-img" src="{{ asset('assets/dist/img/user3-128x128.jpg') }}" alt="message user image" /><!-- /.direct-chat-img -->
                  <div class="direct-chat-text">
              ...
              <div class="direct-chat-contacts">
                <ul class='contacts-list'>
                  ...
                  <li>
                    <a href='#'>
                      <img class='contacts-list-img' src='{{ asset('asset/dist/img/user6-128x128.jpg') }}'/>
                      <div class='contacts-list-info'>
                        <span class='contacts-list-name'>
                          John K.
                  ...
                  <li>
                    <a href='#'>
                      <img class='contacts-list-img' src='{{ asset('asset/dist/img/user8-128x128.jpg') }}'/>
                      <div class='contacts-list-info'>
                        <span class='contacts-list-name'>
                          Kenneth M.
