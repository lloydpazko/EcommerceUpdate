...
@extends('layouts.app')
@section('style')
    <link rel="stylesheet" href="{{ url('frontpages/assets/css/plugins/nouislider/nouislider.css') }}">
    <style type="text/css">
    .active-color{
...
@section('content')
<main class="main">
    <div class="page-header text-center" style="background-image: url('frontpages/assets/images/page-header-bg.jpg')">
        <div class="container">
            ...
            <div class="row">
                ...
                <aside class="col-lg-3 order-lg-first">
                    <form id="FilterForm" method="post" action="">
                        ...
                        <input type="hidden" name="old_category_id" value="{{ !empty($getSubCategory)? $getCategory->id : ''}}">
                            ...
                            <div class="collapse show" id="widget-3">
                                <div class="widget-body">
                                    <div class="filter-colors">
                                        ...
                                        <a href="javascript:;" class="ChangesColor" data-val="0" id="{{ $f_color->id }}" style="background: {{ $f_color->code }};"><span class="sr-only">{{ $f_color->name }}</span></a>
                                        @endforeach
...
@endsection
@section('scripts')
    <script src="{{ url('frontpages/assets/js/wNumb.js') }}"></script>
    <script src="{{ url('frontpages/assets/js/bootstrap-input-spinner.js') }}"></script>
    <script src="{{ url('frontpages/assets/js/nouislider.min.js') }}"></script>
...
$('.ChangeSortBy').change(function() {
    ...
    $('.ChangesColor').click(function() {
        ...
        if(status == 0)
    {
        var status = $(this).attr('data-val', 1);
        $(this).addClass('active-color');
    }
    else
    {
        var status = $(this).attr('data-val', 0);
        $(this).removeClass('active-color');
    }

    var ids= '';
    $('.ChangesColor').each(function() {
        var status = $(this).attr('data-val');
            if(status == 1)
        {
            var id = $(this).attr('id');
